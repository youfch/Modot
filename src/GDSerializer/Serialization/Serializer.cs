...
namespace Godot.Serialization
{
    ...
    public class Serializer : ISerializer
    {
        ...
        /// <param name="referenceSources">An <see cref="IEnumerable{T}"/> of <see cref="XmlNode"/>s to use when deserializing <see cref="XmlNode"/>s that refer other <see cref="XmlNode"/>s through an ID.</param>
        // Fully qualified because net10.0 introduces System.Collections.Generic.OrderedDictionary,
        // which would otherwise make the unqualified name ambiguous
        public Serializer(Godot.Utility.OrderedDictionary<Type, ISerializer> specializedSerializers, IEnumerable<XmlNode>? referenceSources = null)
        {
        ...
        // Fully qualified because net10.0 introduces System.Collections.Generic.OrderedDictionary,
        // which would otherwise make the unqualified name ambiguous
        public Godot.Utility.OrderedDictionary<Type, ISerializer> Specialized
        {
            get;
        }
